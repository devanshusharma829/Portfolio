...
$(".pl1").on("click",function () {
    $("#title").css("background-image","linear-gradient(to left,rgba(4, 9, 30, 0.7),rgba(4, 9, 30, 0.7)),url('Images/Background1.jpg')");
    $(":root").css("--pcolor","#851d1b");
})

$(".pl2").on("click",function () {
    $("#title").css("background-image","linear-gradient(to left,rgba(4, 9, 30, 0.7),rgba(4, 9, 30, 0.7)),url('Images/Background2.jpg')");
    $(":root").css("--pcolor","#2A1537");
})

$(".pl3").on("click",function () {
    $("#title").css("background-image","linear-gradient(to left,rgba(4, 9, 30, 0.7),rgba(4, 9, 30, 0.7)),url('Images/Background3.jpg')");
    $(":root").css("--pcolor","#323826");
})

$(".pl4").on("click",function () {
    $("#title").css("background-image","linear-gradient(to left,rgba(4, 9, 30, 0.7),rgba(4, 9, 30, 0.7)),url('Images/Background4.jpg')");
